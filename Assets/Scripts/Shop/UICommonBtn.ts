...
export default class UICommonBtn extends ZepetoScriptBehaviour {
    ...
    private InitMessageHandler() {
        //button listener
        this.gainBalanceBtn.onClick.AddListener(() =>this.OnClickGainBalance(Currency.wak, 10));
        this.useBalanceBtn.onClick.AddListener(() => this.OnClickUseBalance(Currency.wak, 10));
